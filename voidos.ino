  ...
  if (M5Cardputer.Keyboard.isChange()) {
    ...
    if (currentMillis - lastDebounceTime >= debounceDelay) {
      if (M5Cardputer.Keyboard.isKeyPressed(',') && !isAppActive) {
        ...
        app = 3;
        displayApp();
      } else if (M5Cardputer.Keyboard.isKeyPressed(KEY_ENTER) && isAppActive && app == 1 && settingsPointer == 4) {
        // go to system info
        M5Cardputer.Speaker.tone(3850, 40);
        app = 4;
        displayApp();
        ...
        app = 5;
        displayApp();
      } else if (M5Cardputer.Keyboard.isKeyPressed('`') && isAppActive && app == 5) {
        // go back to main settings menu from wifi settings
        M5Cardputer.Speaker.tone(2000, 40);
        app = 1;
        settingsPointer = 1;
        displayApp();
      } else if (M5Cardputer.Keyboard.isPressed() && isAppActive && app == 5) {
...
void displaySmallTime() {
  ...
  if (timeMin < 10) {
    if (timeHour < 10) {
      M5Cardputer.Display.drawString("0" + strTimeHour + ":0" + strTimeMin, 195, 5);
    } else {
      M5Cardputer.Display.drawString("" + strTimeHour + ":0" + strTimeMin, 195, 5);
    }
  } else {
    if (timeHour < 10) {
      M5Cardputer.Display.drawString("0" + strTimeHour + ":" + strTimeMin, 195, 5);
    } else {
      M5Cardputer.Display.drawString("" + strTimeHour + ":" + strTimeMin, 195, 5);
    }
  }
}
...
void displayApp() {
  ...
  switch (app) {
    case 1:
      ...
      M5Cardputer.Display.setTextSize(0.5);
      if (settingsPointer == 1) {
        M5Cardputer.Display.drawString("> Set Wifi...", 5, 40);
      } else {
        M5Cardputer.Display.drawString("Set Wifi...", 5, 40);
      }
      if (settingsPointer == 2) {
        M5Cardputer.Display.drawString("> Set Time...", 5, 55);
      } else {
        M5Cardputer.Display.drawString("Set Time...", 5, 55);
      }
      if (settingsPointer == 3) {
        M5Cardputer.Display.drawString("> Personalize...", 5, 70);
      } else {
        M5Cardputer.Display.drawString("Personalize...", 5, 70);
      }
      if (settingsPointer == 4) {
        M5Cardputer.Display.drawString("> System info...", 5, 85);
      } else {
        M5Cardputer.Display.drawString("System info...", 5, 85);
      }
      break;
    ...
    case 3:
      ...
      if (personalizePointer == 2) {
        if (personalizeHsWidget == 0) {
        M5Cardputer.Display.drawString("> Widget: None", 5, 55);
        } else if (personalizeHsWidget == 1) {
        M5Cardputer.Display.drawString("> Widget: BatLevel", 5, 55);
        } else if (personalizeHsWidget == 2) {
        M5Cardputer.Display.drawString("> Widget: test", 5, 55);
        }
      } else {
        if (personalizeHsWidget == 0) {
        M5Cardputer.Display.drawString("Widget: None", 5, 55);
    ...
    case 4:
      ...
      M5Cardputer.Display.drawString("v" + osver, 5, 55);
      break;
    case 5:
      // wifi settings
      M5Cardputer.Display.clear();
      ...
      M5Cardputer.Display.setTextSize(1);
      M5Cardputer.Display.drawString("< Set Wifi...", 5, 5);
      M5Cardputer.Display.setTextSize(0.5);
      M5Cardputer.Display.drawString("Work in progress...", 5, 40);
      break;
  }
}
} 